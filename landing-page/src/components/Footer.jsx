...
function Footer() {
  return (
    <footer className="flex flex-col ">
      <div className="flex h-[488px]  gap-[130px] bg-[#F8F8FD] px-[304px] py-[94px]">
        ...
        <div>
          ...
          <ul className="w-max space-y-6">
            <li className="text-base font-light text-[#8A8FB9]">My Account</li>
      ...
      <div className="flex h-[56px] items-center justify-between bg-[#E5E0FC] px-[304px]">
        ...
        <div className="flex items-center gap-4">
          ...
          <img src={instagramLogo} alt="instagram" className="cursor-pointer" />
        </div>
      </div>
    </footer>
  );
